...
<head>
    ...
    <meta name="keyword" content="Dashboard, IDE, SonarQubr">
    ...
    <link rel="stylesheet" href="lib/lineicons/style.css">
    <!-- Custom styles for this template -->
    <link href="assets/css/style.css" rel="stylesheet">
    <link href="assets/css/style-responsive.css" rel="stylesheet">

    <link rel="stylesheet" href="assets/css/sprint-plan.css" />
...
<body>
    ...
    *********************************************************************************************************************************************************** -->
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                              ...
                              <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class=" add-task-row">
                                        <a id="addNewTask" class="btn btn-success btn-sm pull-left" data-toggle="modal" href="#myModal">Add New Tasks</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer centered">
                                                    <button id="unLock" class="btn btn-theme03" type="button">Unlock</button>
                    ...
                    <div class="row mt mb">
                        <div class="col-md-4 mb" id=pending>
                            <div class="white-panel pn">
                                <h3>Pending</h3>
                            </div>
                        </div>
                
                        <div class="col-md-4 mb" id="inProgress">
                            <div class="white-panel pn">
                                <h3>In Progress</h3>
                            </div>
                        </div>
                
                        <div class="col-md-4 mb" id="completed">
                            <div class="white-panel pn">
                                <h3>Completed</h3>
                            </div>
                        </div>
        ...
        <footer class="site-footer">
            <div class="text-center">
                If you have any question : bulgogi1216@naver.com
                <a href="sprint-plan.html#" class="go-top">
    ...
    <script src='node_modules/dcjqaccordion/js/jquery.cookie.js'></script>
    <script src='node_modules/dcjqaccordion/js/jquery.hoverIntent.minified.js'></script>
    <script class="include" src="node_modules/dcjqaccordion/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="node_modules/jquery.scrollto/jquery.scrollTo.min.js"></script>
    <script src="node_modules/nicescroll/dist/jquery.nicescroll.min.js" type="text/javascript"></script>

    <!--common script for all pages-->
    <script src="lib/common-scripts/common-scripts.js"></script>

    <!--script for this page-->
	<script src="lib/jquery-ui-1.12.1/jquery-ui.min.js"></script>
    <script src="assets/js/sprint-plan.js"></script>
